...
def calculate():
	global expression, ans, x, y, algebricMethod, simplifyMethod
...
def simplify():
	global simplifyMethod, algebricMethod
	
	simplifyMethod = True
	algebricMethod = False
...
typeChoose = ttk.Combobox(root, values = ('algebric eq', 'simplify'), height = 8, width = 15,state='readonly', textvariable = defOpt2)
